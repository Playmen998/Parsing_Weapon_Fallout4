...
"""
Поиск параметров для оружия (ближний бой)
"""
for i in range(2):
...
df = pd.DataFrame(data =all_table,columns = ["Название","Тип_Оружия", "Урон", "Урон_Секунду", "Очки_Действия", "Вес", "Цена"])
df.to_csv('melee.csv', index = True)
